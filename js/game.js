class Game{
    ...
    async start() {
            ...
            target = createSprite(500,10,1000,20)
    ...
    play(){
                ...
                Player.getPlayerInfo();
                 ...
                 for(var plr in allPlayers){
                     ...
                     if(players[index-1].isTouching(target)){
                ...
                if (keyIsDown(UP_ARROW) && player.index !== null) {
                 ...
                 if (frameCount % 15 === 0) {
                    ...
                    if (position === 1){
                     fruits = createSprite( 0, random(0,600), 100, 100);
                     //fruits.debug = true;
                     fruits.setCollider("circle",0,0,100)
                     fruits.velocityX = 9;
                    }
                    else if(position === 2){
                        fruits = createSprite( 1000, random(0,600), 100, 100);
                       //fruits.debug = true;
                        fruits.setCollider("circle",0,0,100)
                     fruits.velocityX = -9;
                    }
